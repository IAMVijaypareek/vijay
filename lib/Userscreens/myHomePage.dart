import 'dart:async';
import 'package:carry_bag/Userscreens/itemdetails.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
import 'package:carry_bag/adminScreens/admin_home.dart';
import 'package:carry_bag/tools/Store.dart';
...
import 'package:carry_bag/Userscreens/item_details.dart';
      ...
      floatingActionButton: new Stack(
        ...
        children: <Widget>[
          new FloatingActionButton(
            onPressed: () {
              Navigator.of(context).push(new CupertinoPageRoute(
                  builder: (BuildContext context) => new Thailicart()));
            },
        ...
        child: new Column(
          children: <Widget>[
            ...
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new ThailiHistory()));
              },
            ),
            new Divider(),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new ThailiProfile()));
              },
            ),
            new ListTile(
              leading: new CircleAvatar(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new ThailiDelivery()));
              },
            ),
            new Divider(),
            new ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (BuildContext context) => new ThailiAboutus()));
              },
              //
            ),
            new ListTile(
  ...
  checkIfLoggedIn() async {
    if (isLoggedIn == false) {
      bool response = await Navigator.of(context).push(new CupertinoPageRoute(
          builder: (BuildContext context) => new ThailiLogin()));
